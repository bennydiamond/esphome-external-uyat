...
class UyatLightRGBW : public EntityBase, public Component, public light::LightOutput {
 public:
  ...
  explicit UyatLightRGBW(Uyat *parent, Config config);
  void setup() override;
 ...
 private:
  ...
  static constexpr const char* TAG = "uyat.light.rgbw";
